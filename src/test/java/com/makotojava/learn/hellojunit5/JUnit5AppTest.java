...
public class JUnit5AppTest {
   ...
   */
  @Test
  @DisplayName("Testing JUnit5AppTest")
  public void testAdd() {
    //
    ...
    //
    // Test
    //  The reference to the class under test cannot be null. If it is, the test should fail.
    ...
    for(int i = 0 ; i < arr3.length; i++) {
     ...
     assertEquals(total2, 1064);
     assertEquals(total3, 12);
  ...
  class NegativeNumbersTest {
     ...
     */
    @Test
    @DisplayName("Test NegativeNumbersTest")
    public void testAdd() {
      //
      ...
      //Make this class a nested test class
      @Nested
      @DisplayName("Test NegativeNumbersTest")
      class Testing {
  ...
  class PositiveAndNegativeNumbersTest {
     ...
     */
    @Test
    @DisplayName("Testing PositiveAndNegativeNumbersTest")
    public void testAdd() {
      //
      // EXERCISE: TODO: ADD CODE HERE (See Javadoc comments for instructions. Use the Javadoc View in Eclipse to see
      // the buttery smooth javadoc above.)
